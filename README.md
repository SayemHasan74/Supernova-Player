...
The current foundation includes the single-instance Qt application shell and
the first playback-engine slice: libmpv lifecycle management, property/event
bridging, OpenGL video rendering, command-line media loading, and basic
...
- Pass a media path as the first positional command-line argument.
